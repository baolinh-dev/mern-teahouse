...
import { faHome, faChartSimple, faUser, faWarehouse, faCartShopping, faNewspaper, faFolderOpen, faMessage  } from '@fortawesome/free-solid-svg-icons';
...
const categories = [
    ...
    { categoryName: 'Chat', categoryIcon: faMessage, url: '/admin/chat' },
